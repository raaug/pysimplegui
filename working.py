...
import PySimpleGUI as sg     # Import the pysimplegui framework
import re                    # Support for regular expressions
from string import Template  # Support for string substitution/namespace
from slist import slist      # The initial list of words
...
layout = [
    ...
    [sg.Checkbox("Check for python regex_string output", key='-CK-')],
...
while True:
    ...
    # Caution! If you guess a duplicate letter and the answer only has a single instance of that letter,
    # the second letter will show gray. You do not want to add the second occurance to the gray-list,
    # as it will filter out accepable words.
    ...
    # The same caution applies to yellow letters. Be careful what you add to the gray-set.
    ...
    if values['-CK-'] == True:
        print(f"/{regex_string}/\n") # Outputs the regular expression to the terminal.
...
#    slist = output_list # Reduce the eligible word list.
